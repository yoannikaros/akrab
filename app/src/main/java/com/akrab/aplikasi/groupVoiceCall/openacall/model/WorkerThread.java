package com.akrab.aplikasi.groupVoiceCall.openacall.model;
    ...
    private RtcEngine ensureRtcEngineReadyLock() {
        if (mRtcEngine == null) {
            ...
            try {
                ...
                mRtcEngine = RtcEngine.create(mContext, "49b8cb3b25144840bb9622c9345785d1", mEngineEventHandler.mRtcEventHandler);
            } catch (Exception e) {
